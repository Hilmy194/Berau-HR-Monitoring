...
import { getOrganizationUnitPositions } from "@/lib/services/hr-core-organization.service";
...
export async function GET(_request: Request, { params }: { params: Promise<{ code: string }> }) {
  ...
  try {
    return cachedHrCoreJson(await getOrganizationUnitPositions(parsed.data));
  } catch (error) {
